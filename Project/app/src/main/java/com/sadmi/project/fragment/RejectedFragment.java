...
public class RejectedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(view==null)
            view = inflater.inflate(R.layout.fragment_rejected, container, false);

        UserSharedPref userSharedPref = new UserSharedPref(getActivity());
        new getRejectedMeetingsTask().execute(userSharedPref.getConnectedUser());
    ...
    class getRejectedMeetingsTask extends AsyncTask<String,String,String> {
        ...
        protected String doInBackground(String... params) {
            ...
            parameters.add(new KeyValue("status","rejected"));
