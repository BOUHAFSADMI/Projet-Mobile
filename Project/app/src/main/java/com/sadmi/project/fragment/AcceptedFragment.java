...
public class AcceptedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        new getAcceptedMeetingsTask().execute(userSharedPref.getConnectedUser());
    ...
    class getAcceptedMeetingsTask extends AsyncTask<String,String,String> {
        ...
        protected String doInBackground(String... params) {
            ...
            parameters.add(new KeyValue("status","accepted"));
